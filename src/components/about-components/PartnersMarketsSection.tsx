          ...
          <div className="space-y-8">
            <div className="text-center space-y-4">
              <div className="flex items-center justify-center gap-4">
                <Globe className="w-8 h-8 text-primary-yellow" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {markets.map((market, index) => (
                <motion.div
                  ...
                  className="bg-slate-50 rounded-2xl p-6 border border-slate-200 shadow-[0_4px_20px_rgba(0,0,0,0.08)] hover:shadow-[0_8px_30px_rgba(0,0,0,0.12)] transition-all duration-300"
                >
                  <h3 className="font-display text-xl text-slate-900 font-semibold mb-3 leading-tight">
                    {market.region}
                  </h3>
